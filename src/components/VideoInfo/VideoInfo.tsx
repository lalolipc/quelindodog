...
const VideoInfo = ({title='', description='', publishedDate='', channelTitle='', channelImage='', viewCount='', likeCount='', dislikeCount='', subs=''}):any => {
    return (
        <div className='videoinfo'>
            ...
            <div className='videoinfo__stats'>
                ...
                <div className="videoinfo__likes">
                    <SideBarRow title={likeCount} />
                    <SideBarRow title={dislikeCount} />
                    <SideBarRow title='SHARE' />
                    <SideBarRow title='SAVE' />
                    <SideBarRow title='' />
                </div>
            </div>
            <hr />
